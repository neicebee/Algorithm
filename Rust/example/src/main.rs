...
// 직원을 해당 부서에 추가하는 함수
fn add_employee(map: &mut HashMap<String, Vec<String>>, query: String) -> bool {
...
fn view_enterprise(map: &HashMap<String, Vec<String>>) {
...
fn view_department_employees(map: &HashMap<String, Vec<String>>, dpm: &String) {
    println!("===[Department]===");
    println!("- {}", dpm);
    println!("=====[Staffs]=====");
    match map.get(dpm) {
